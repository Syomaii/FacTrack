...
<main class="dashboard-main">
    ...
    <div class="dashboard-main-body">
        <div class="d-flex flex-wrap align-items-center justify-content-between gap-3 mb-24">
            <h6 class="fw-semibold mb-0">Repair</h6>
            <ul class="d-flex align-items-center gap-2">
                ...
                <li>-</li>
                <li class="fw-medium">Repair</li>
            </ul>
        </div>

        @if (session('repairSuccessfully'))
            <div
                class="alert alert-success bg-success-100 text-success-600 border-success-600 border-start-width-4-px border-top-0 border-end-0 border-bottom-0 px-24 py-13 mb-3 fw-semibold text-lg radius-4 d-flex align-items-center justify-content-between">
                <div class="d-flex align-items-center gap-2">
                    <iconify-icon icon="akar-icons:double-check" class="icon text-xl"></iconify-icon>
                    {{ session('repairSuccessfully') }}
                </div>
            </div>
        @endif
                ...
                <div class="row justify-content-center">
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="card border shadow-sm">
                            <div class="card-body">
                                <form action="{{ route('repair_equipment') }}" method="post" id="repairEquipmentForm">
                                    @csrf
                                    ...
                                    <div class="d-flex justify-content-center gap-3 py-2 ">
                                        ...
                                        <button type="button" class="btn btn-primary px-20 py-11 " data-bs-toggle="modal"
                                            data-bs-target="#scanModalRepair" id="scanCodeRepair">
                                            Scan QR Code
                                        </button>
                                    ...
                                    <div class="modal fade" id="scanModalRepair" tabindex="-1"
                                        aria-labelledby="scanModalRepairLabel" aria-hidden="true">
                                        <div class="modal-dialog modal-dialog-centered">
                                            <div class="modal-content">
                                                <div class="modal-header">
                                                    <h5 class="modal-title" id="scanModalRepairLabel">Repair Equipment</h5>
                                                    <button type="button" class="btn-close" data-bs-dismiss="modal"
                                                        aria-label="Close"></button>
                                                </div>
                                                <div class="modal-body">
                                                    <div id="previewRepair"
