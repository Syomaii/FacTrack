                    ...
                    <div class="col-xxl-6 col-xl-8 col-lg-10">
                        <div class="card border shadow-sm">
                            <div class="card-body">
                                ...
                                <ul>
                                    <li><strong>Maintenance ID:</strong> {{ $maintenance_id_no }}</li>
                                    <li><strong>Maintenance Description:</strong> {{ $maintenance_description }}</li>
                                ...
                                <form action="{{ route('maintenance-equipment-post', $equipment->id) }}" method="post">
                                    ...
                                    <input type="hidden" name="maintenance_description"
