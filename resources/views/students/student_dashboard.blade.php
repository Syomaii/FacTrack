                ...
                <div class="card shadow-sm p-3 rounded" style="background-color: #ffff;">
                    <div class="d-flex align-items-center">
                        ...
                        <div class="profile-icon d-flex align-items-center justify-content-center"
                            style="position: relative; left: -50px; width: 500px; height: 250px; border-radius: 8px; background-color: #ffff;">
                            <img src="{{ asset('images/student.png') }}" alt="Profile Image"
                                class="icon text-l rectangle" style="width: 100%; height: 100%; object-fit: cover;">
                        </div>
                    </div>
                </div>
            </div>
                                    ...
                                    <div class="card shadow-sm p-3 rounded w-100">
                                        @foreach ($studentReservations as $reservations)
                                            ...
                                            @if ($reservations->reservation_date === now()->format('Y-m-d'))
                                                <div
                                                    class="card d-flex justify-content-between align-items-center mb-3">
                                                    <h6 class="fw-semibold mb-0">{{ $reservations->facility->name }}
                                                    </h6>
                ...
                <div class="col-lg-4">
                    <div class="card shadow-sm p-3 rounded">
                        <div class="calendar">
                            ...
                            <!-- Days of the Week -->
                            <div class="d-flex justify-content-between text-center text-muted fw-semibold mb-1"
...
<style>
    ...
    .calendar-day:hover {
        ...
        /* Light background when hovering */
        cursor: pointer;
    }
