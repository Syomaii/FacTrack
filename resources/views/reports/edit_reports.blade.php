                                ...
                                <div class="row justify-content-between g-3">
                                    <div class="col-sm-4">
                                        ...
                                        <p class="mb-1 text-sm">Date Issued: <span
                                                ...
                                                class="text-success-main"><iconify-icon
                                        ...
                                        <table class="text-sm text-secondary-light">
                                            <tbody>
                                                <tr>
                                                    <td>Name</td>
                                                    <td class="ps-8">: <span
                                                            class="editable text-decoration-underline">Will
                                                            Marthas</span> <span class="text-success-main"><iconify-icon
                                                                icon="mage:edit"></iconify-icon></span></td>
                                                </tr>
                                                <tr>
                                                    <td>Address</td>
                                                    <td class="ps-8">: <span
                                                            class="editable text-decoration-underline">4517 Washington
                                                ...
                                                <tr>
                                                    <td>Phone number</td>
                                                    <td class="ps-8">: <span
                                                            class="editable text-decoration-underline">+1 543
                                                            2198</span> <span class="text-success-main"><iconify-icon
                                                                icon="mage:edit"></iconify-icon></span></td>
                                                </tr>
                                            </tbody>
                                        </table>
                                            ...
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <button type="button" class="remove-row"><iconify-icon
                                            ...
                                            <table class="text-sm">
                                                <tbody>
                                                    <tr>
                                                        ...
                                                        <td class="pe-16">
                                                            <span
                                                                class="text-primary-light fw-semibold">$4000.00</span>
                                                        </td>
                                                    </tr>
                                                    <tr>
