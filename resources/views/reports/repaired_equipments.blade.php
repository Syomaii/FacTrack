                                            ...
                                            <table class="table bordered-table text-sm">
                                                <thead>
                                                    <tr>
                                                        ...
                                                        <th scope="col" class="text-sm">Repaired Date</th>
                                                ...
                                                <tbody id="repairedEquipmentsTable">
...
<script>
    document.getElementById('dateRangeForm').addEventListener('submit', function(event) {
        ...
        fetch(
                `/repaired-equipment-reports?start=${encodeURIComponent(startDate)}&end=${encodeURIComponent(endDate)}`
            )
    ...
    function updateEquipmentTable(data) {
        var tableBody = document.getElementById('repairedEquipmentsTable');
        ...
        if (Array.isArray(data) && data.length) {
            data.forEach(item => {
                ...
                if (item) {
                    ...
                    var technician = item.technician || 'N/A';
                    var repaired_date = item.repaired_date || 'N/A';
                    var returned_date = item.returned_date || 'N/A';
                    var status = item.status || 'N/A';
                    var recommendations = item.recommendations || 'N/A';
